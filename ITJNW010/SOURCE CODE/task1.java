   ...
   // String content="Demo from task1";
    ...
    while(true)
    {
       ...
       // System.out.println("Total time is"+total);
        ...
        {
    st.executeUpdate("delete from MFT where location='"+right+"'");
    System.out.println("Deleted");
    mains.out1.close();
    JOptionPane.showMessageDialog(null,"Communication via Right Node is discarded  ","Group Information",JOptionPane.OK_OPTION);
